...
OAOAOA            Square(1, None)
OAOAOA
    def test_str_x(self):
OAOAOA        with self.assertRaisesRegex(TypeError, "x must be an integer"):
OAOAOA            Square(1, "invalid")
OAOAOA
...
OAOAOA        with self.assertRaisesRegex(TypeError, "x must be an integer"):
OAOAOAOAOAOA            Square(1, True)
OAOAOA
...
OAOAOA
    def test_tuple_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
OAOAOAOAOAOAOAOAOAOAOAOA            Square(1, (1, 2, 3))

OAOAOA    def test_frozenset_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
...
OAOAOA    def test_bytes_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
OAOAOAOAOAOAOAOAOAOAOAOA            Square(1, b'Python')
    ...
    def test_memoryview_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
OAOAOA            Square(1, memoryview(b'abcedfg'))

OAOAOA    def test_inf_x(self):
OAOAOAOAOAOAOAOAOAOAOAOA        with self.assertRaisesRegex(TypeError, "x must be an integer"):
...
OAOAOA        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            Square(5, -1, 0)
...
OAOAOAOAOAOA    def test_None_y(self):
OAOAOA        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OAOAOAOAOAOA            Square(1, 3, None)

    def test_str_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OAOAOA            Square(1, 1, "invalid")
...
OAOAOAOAOAOAOAOAOAOAOAOA        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OAOAOA            Square(1, 3, complex(5))

    def test_dict_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OAOAOA            Square(1, 1, {"a": 1, "b": 2})
OAOAOA
OAOAOA    def test_list_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OAOAOA            Square(1, 1, [1, 2, 3])

    def test_set_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 1, {1, 2, 3})

OAOAOA    def test_tuple_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OAOAOAOAOAOAOAOAOA            Square(1, 1, (1, 2, 3))
...
OBOB        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OBOBOB            Square(1, 3, memoryview(b'abcedfg'))

    def test_inf_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OBOBOB            Square(1, 1, float('inf'))
...
OAOA    """Unittests for testing order of Square attribute initialization."""
